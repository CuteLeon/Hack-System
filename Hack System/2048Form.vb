Public Class Game2048Form
    ...
    Private Sub GameForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Icon = My.Resources.GameResource.Game2048Icon
        Dim DirectiionKeyBitmap As Bitmap = My.Resources.GameResource.DirectiionKey
    ...
    Private Sub DrawForm()
        ...
        Dim UnityBitmap As Bitmap = My.Resources.GameResource.Game2048Background
        Using UnityGraphics As Graphics = Graphics.FromImage(UnityBitmap)
            For IndexY As Integer = 0 To 3
                For IndexX As Integer = 0 To 3
                    UnityGraphics.DrawImage(My.Resources.GameResource.ResourceManager.GetObject("Card" & CardData(IndexY, IndexX)), PaddingSize + IndexX * 70, PaddingSize + IndexY * 74 + TitleHeight, 70, 74)
                Next
            Next
        End Using
...
#Region "关闭按钮"
    ...
    Private Sub CloseButton_MouseDown(sender As Object, e As MouseEventArgs) Handles CloseButton.MouseDown
        CloseButton.Image = My.Resources.GameResource.GameClose_2
    End Sub

    Private Sub CloseButton_MouseEnter(sender As Object, e As EventArgs) Handles CloseButton.MouseEnter
        CloseButton.Image = My.Resources.GameResource.GameClose_1
    End Sub

    Private Sub CloseButton_MouseLeave(sender As Object, e As EventArgs) Handles CloseButton.MouseLeave
        CloseButton.Image = My.Resources.GameResource.GameClose_0
    End Sub
